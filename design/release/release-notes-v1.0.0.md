...
| Documented governance, release, licensing, trademark, upgrade, and deprecation policies | PASS — `GOVERNANCE.md`, `RELEASES.md`, `TRADEMARKS.md`, `design/protocol/versioning.md` |
| Published boundary declaring L4 and AGI as non-goals | PASS — `design/roadmap.md`, `design/roadmap/adaptation-layer.md` |
...
The deferred external-evidence gates are recorded as the 1.1 exit criteria in `RELEASES.md` and `design/roadmap/adaptation-layer.md`. 1.1 does not introduce new protocol features.
