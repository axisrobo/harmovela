...
> **Superseded by 1.0.** The in-repository matrix evidence was completed, but the external-evidence exit gates below were not satisfied and were deferred to 1.1 by explicit compatibility decision (see `design/release/release-notes-v1.0.0.md`).
...
Release criteria (met by explicit compatibility decision; see `design/release/release-notes-v1.0.0.md`):
